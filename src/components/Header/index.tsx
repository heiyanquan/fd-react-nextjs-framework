      ...
      children: [
        {
          key: '分析色谱',
          label: (
            <Link target="_self" rel="noopener noreferrer" href="/products/last-child?id=111">
              分析色谱
            </Link>
          )
        }
      ...
      children: [
        {
          key: 'ADC和生物偶联',
          label: (
            <Link target="_self" rel="noopener noreferrer" href="/services/last-child?id=111">
              ADC和生物偶联
            </Link>
          )
        }
  ...
  return (
    <div className="common-header-wrapper">
      <Flex align="center" gap={'middle'} className="px-20 py-6">
        <Link href="/">
          <Image src="/img/header/logo.png" alt="" width={150} height={48} />
        </Link>
